...
function EditStudentPage() {
    ...
    const id = params?.id;
    // Fetch student data
    const { data: studentData, isLoading: isLoadingStudent } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].student.getById.useQuery({
        id
    }, {
        enabled: !!id
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (studentData) {
            ...
            setSubjects(studentData.subjects?.map((subject)=>({
                    id: subject.id,
                    name: subject.name,
            ...
            if (studentData.behavioralNotes && studentData.behavioralNotes.length > 0) {
                setBehavioralNote(studentData.behavioralNotes[studentData.behavioralNotes.length - 1].content);
            }
        }
    }, [
        studentData
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("No student ID provided");
            return;
        }
        try {
...
//# sourceMappingURL=_ac598ad9._.js.map